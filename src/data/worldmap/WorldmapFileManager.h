...
namespace VGears {
     ...
     * Manages map files.
     */
    class _VGearsExport WorldmapFileManager
       : public Ogre::ResourceManager, public Ogre::Singleton<WorldmapFileManager>
    {
        public:
             ...
             * Destructor.
             */
            virtual ~WorldmapFileManager();

            /**
             * Retrieves a singleton to the manager.
             */
            static WorldmapFileManager& GetSingleton();

            /**
             * Retrieves a pointer to the manager singleton.
             */
            static WorldmapFileManager* GetSingletonPtr();
