 ...
 *   "80.4%20.6" -> value = 20.6, percent_value = 80.4
 *   "80.4" -> value = 80.4, percent_value = 0
 *
 * @param[out] value_percent Percent value
 ...
 *   "7.2%" -> length * 7.2
 *
 * @param[in] length Keyframe duration, used only for percentages.
 * @param[in] string Input string
