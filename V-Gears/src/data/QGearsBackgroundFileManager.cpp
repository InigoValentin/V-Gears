...
template<> QGears::BackgroundFileManager
  *Ogre::Singleton<QGears::BackgroundFileManager>::msSingleton = nullptr;
...
namespace QGears{
    ...
    Ogre::Resource *BackgroundFileManager::createImpl(
      ...
      const Ogre::NameValuePairList *create_params
        ...
        return new BackgroundFile(this, name, handle, group, is_manual, loader);
    }
