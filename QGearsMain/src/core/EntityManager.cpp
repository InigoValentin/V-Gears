    ...
    encounter_rate_(0)
{
    ...
    m_Grid = Ogre::Root::getSingleton().getSceneManager("Scene")->createEntity("Grid", "grid.mesh");
    m_SceneNode->attachObject(m_Grid);
    //m_Axis = Ogre::Root::getSingleton().getSceneManager("Scene")->createEntity("Axis", "system/axis.mesh");
    m_Axis = Ogre::Root::getSingleton().getSceneManager("Scene")->createEntity("Axis", "axis.mesh");
...
//bool EntityManager::StartBattle(unsigned int formation){
