    ...
    m_AnimationAutoPlay(true)
{
    ...
    Ogre::MaterialPtr matDirection = Ogre::MaterialManager::getSingleton().getByName("entity/direction");
    m_Direction->setMaterial(matDirection);
    ...
    Ogre::MaterialPtr matSolidCollision = Ogre::MaterialManager::getSingleton().getByName("entity/solid_collision");
    m_SolidCollision->setMaterial(matSolidCollision);
    ...
    Ogre::MaterialPtr matTalkCollision = Ogre::MaterialManager::getSingleton().getByName("entity/talk_collision");
    m_SolidCollision->setMaterial(matTalkCollision);
