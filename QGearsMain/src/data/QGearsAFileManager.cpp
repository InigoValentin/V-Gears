...
template<> QGears::AFileManager
  *Ogre::Singleton<QGears::AFileManager>::msSingleton = nullptr;

namespace QGears{

    AFileManager *AFileManager::GetSingletonPtr(){return msSingleton;}
    ...
    Ogre::Resource *AFileManager::createImpl(
      ...
      const Ogre::NameValuePairList *create_params
        ...
        return new AFile(this, name, handle, group, is_manual, loader);
    }
